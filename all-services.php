...
?>
    ...
    <div class="banner"
        ...
        <div class="content active">
            ...
            <h4>
                <span><?= $chosen_services['service_title'] ?></span><span>$<?= $chosen_services['service_price'] ?></span><span><?= $chosen_services['service_time'] ?> minutes</span>
            </h4>
    ...
    <div class="carousel-box">
        ...
        <?php while ($chosen_services = mysqli_fetch_assoc      ($chosen_services_info)) : ?>
            <div class="carousel-item" onclick="changeBg('<?= $chosen_services['service_img'] ?>', '<?= $chosen_services['id'] ?>')">
